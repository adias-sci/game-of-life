...
create policy "Anyone can read life games"
on public.life_games for select using (true);

create policy "Anyone can insert life games"
on public.life_games for insert with check (true);

create policy "Anyone can update life games"
on public.life_games for update using (true) with check (true);
